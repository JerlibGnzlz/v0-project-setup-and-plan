    ...
    <div className="space-y-6">
        ...
        <div className="flex-1 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
              <DialogHeader>
                <DialogTitle>{editingNoticia ? 'Editar Noticia' : 'Nueva Noticia'}</DialogTitle>
              </DialogHeader>
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 mt-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input type="datetime-local" {...register('fechaPublicacion')} />
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <Select
          ...
          onValueChange={(value: CategoriaNoticia | 'TODAS') => setFilterCategoria(value)}
        >
        ...
        <Select
          ...
          onValueChange={(value: 'TODOS' | 'PUBLICADOS' | 'BORRADORES') =>
            setFilterPublicado(value)
          }
        >
