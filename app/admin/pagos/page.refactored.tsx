...
import { PagosTableHeader } from '@/components/admin/pagos/pagos-table-header'
import { PagosTable } from '@/components/admin/pagos/pagos-table'
import { PagoValidarDialog } from '@/components/admin/pagos/pago-validar-dialog'
import { PagoRechazarDialog } from '@/components/admin/pagos/pago-rechazar-dialog'
import { PagoRehabilitarDialog } from '@/components/admin/pagos/pago-rehabilitar-dialog'
