...
export default function PagosPage() {
  ...
  const confirmarPago = async () => {
    ...
    try {
      ...
      if (numeroCuota) {
        toast.success(
          `Cuota ${numeroCuota}/${numeroCuotasTotal} validada exitosamente. Si es la última cuota, la inscripción será confirmada automáticamente.`
        )
      } else {
          ...
          <Card className="border-emerald-200/50 dark:border-emerald-500/20 bg-gradient-to-br from-white to-emerald-50/30 dark:from-background dark:to-emerald-950/20 overflow-hidden">
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                {pagosSeleccionados.size > 0 &&
                  filteredPagos.some(
                    (p: any) => pagosSeleccionados.has(p.id) && p.estado !== 'COMPLETADO'
                  ) && (
                    <Button
                      ...
                      <th className="p-3 text-sm font-medium w-12">
                        ...
                        >
                          ...
                          filteredPagos
                            ...
                            .every((p: any) => pagosSeleccionados.has(p.id)) ? (
                    ...
                    {filteredPagos.length === 0 ? (
                      ...
                      filteredPagos.map((pago: any) => {
                        ...
                        const nombreCompleto = inscripcion
                          ...
                          : 'N/A'
                        const monto =
                          typeof pago.monto === 'number' ? pago.monto : parseFloat(pago.monto || 0)
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="p-3">
                              ...
                              {pago.referencia &&
                                pago.referencia !== inscripcion?.codigoReferencia && (
                              ...
                              <Tooltip>
                                <TooltipTrigger asChild>
                                  ...
                                  >
                                    ...
                                    <span className="ml-1">
                                      {getOrigenLabel(origenInscripcion)}
                                    </span>
                                  </Badge>
                                </TooltipTrigger>
                                <TooltipContent>
                  ...
                  {pagoAValidar && (
                    <div className="bg-muted/50 rounded-lg p-4 space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium text-foreground">
                          {pagoAValidar.numeroCuota || 1} /{' '}
                          {pagoAValidar.inscripcion?.numeroCuotas || 3}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        ...
                        <span className="font-bold text-emerald-600 dark:text-emerald-400">
                          $
                          {(typeof pagoAValidar.monto === 'number'
                            ? pagoAValidar.monto
                            : parseFloat(pagoAValidar.monto || 0)
          ...
          <DialogContent>
              ...
              <div className="space-y-4">
                <div className="bg-red-50 dark:bg-red-950/30 rounded-lg p-4 space-y-2 text-sm border border-red-200 dark:border-red-800">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-red-900 dark:text-red-100">
                      {pagoARechazar.numeroCuota || 1} /{' '}
                      {pagoARechazar.inscripcion?.numeroCuotas || 3}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold text-red-900 dark:text-red-100">
                      $
                      {(typeof pagoARechazar.monto === 'number'
                        ? pagoARechazar.monto
                        : parseFloat(pagoARechazar.monto || 0)
                      ).toLocaleString('es-AR')}
                    </span>
                  </div>
                </div>
            ...
            <DialogFooter>
              ...
              <Button
                ...
                disabled={
                  rechazarPagoMutation.isPending || !motivoRechazo || motivoRechazo === 'otro'
                }
              >
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription asChild>
                <div className="space-y-4">
                  <p>
                    ¿Estás seguro de que deseas rehabilitar este pago? Esto permitirá al usuario
                    volver a enviar su comprobante.
                  </p>
                    ...
                    <div className="bg-blue-50 dark:bg-blue-950/30 rounded-lg p-4 space-y-2 text-sm border border-blue-200 dark:border-blue-800">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium text-blue-900 dark:text-blue-100">
                          {pagoAReabilitar.inscripcion?.nombre}{' '}
                          {pagoAReabilitar.inscripcion?.apellido}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-blue-700 dark:text-blue-300">Cuota:</span>
                        <span className="font-medium text-blue-900 dark:text-blue-100">
                          {pagoAReabilitar.numeroCuota || 1} /{' '}
                          {pagoAReabilitar.inscripcion?.numeroCuotas || 3}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        ...
                        <span className="font-bold text-blue-900 dark:text-blue-100">
                          $
                          {(typeof pagoAReabilitar.monto === 'number'
                            ? pagoAReabilitar.monto
                            : parseFloat(pagoAReabilitar.monto || 0)
                          ).toLocaleString('es-AR')}
                        </span>
                      </div>
            ...
            <AlertDialogFooter>
              ...
              >
                {rehabilitarPagoMutation.isPending
                  ? 'Rehabilitando...'
