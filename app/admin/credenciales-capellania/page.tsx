...
type WizardStep = 'solicitudes' | 'credenciales'

export default function CredencialesCapellaniaPage() {
  ...
  const { data: credencialesData, isLoading: loadingCredenciales } = useCredencialesCapellania(
    1,
    50
  )
  ...
  const handleCredencialCreated = async (credencial: CredencialCapellania) => {
    ...
    try {
      ...
      await updateMutation.mutateAsync({
        ...
        dto: {
          ...
          credencialCapellaniaId: credencial.id,
        },
      })
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Gestiona solicitudes y credenciales de capellanía en un solo lugar
          </p>
        </div>
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Visualiza y gestiona todas las credenciales de capellanía creadas
          </p>
        </div>
        <div className="flex gap-2">
      ...
      <Dialog open={showDetailDialog} onOpenChange={setShowDetailDialog}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Información completa de la solicitud de credencial de capellanía
            </DialogDescription>
          </DialogHeader>
          {selectedSolicitud && (
            <div className="space-y-4">
