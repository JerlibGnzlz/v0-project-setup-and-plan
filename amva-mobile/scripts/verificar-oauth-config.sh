...
echo ""
echo "   1. Ve a: https://console.cloud.google.com/apis/credentials?project=amva-auth"
...
echo ""
echo "   1. Ve a: https://console.cloud.google.com/apis/credentials/consent?project=amva-auth"
