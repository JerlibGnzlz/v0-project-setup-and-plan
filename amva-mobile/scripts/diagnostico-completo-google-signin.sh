...
echo ""
echo "   URL: https://console.cloud.google.com/apis/credentials?project=amva-auth"
echo "   Pasos:"
...
echo ""
echo "   Credentials: https://console.cloud.google.com/apis/credentials?project=amva-auth"
echo "   OAuth Consent: https://console.cloud.google.com/apis/credentials/consent?project=amva-auth"
echo ""
