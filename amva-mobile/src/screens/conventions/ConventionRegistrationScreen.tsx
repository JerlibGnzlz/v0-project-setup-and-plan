        ...
        <ScrollView style={styles.container} contentContainerStyle={styles.content}>
            <View style={styles.header}>
                ...
                {convencion.ubicacion && (
                    <Text style={styles.subtitle}>📍 {convencion.ubicacion}</Text>
                )}
                ...
                <View style={styles.costContainer}>
                    ...
                    <Text style={styles.costValue}>{numeroCuotas} cuotas de ${Number(montoPorCuota).toFixed(2)}</Text>
                </View>
            </View>
            ...
            <View style={styles.cuotasContainer}>
                {['1', '2', '3'].map((num) => (
                    <TouchableOpacity
                        ...
                        style={[
                            styles.cuotaButton,
                            numeroCuotas === num && styles.cuotaButtonActive,
                        ]}
                        onPress={() => setNumeroCuotas(num)}
                    >
                        <Text
                            style={[
                                styles.cuotaButtonText,
                                numeroCuotas === num && styles.cuotaButtonTextActive,
                            ]}
                        >
                            {num}
                        </Text>
            ...
            <Text style={styles.cuotaInfo}>
                {numeroCuotas} cuota{numeroCuotas !== '1' ? 's' : ''} de ${Number(montoPorCuota).toFixed(2)} cada una
            </Text>
            ...
            <Text style={styles.hint}>
                Los campos marcados con * son obligatorios. Tu inscripción será procesada y recibirás confirmación.
            </Text>
        </ScrollView>
    )
}
