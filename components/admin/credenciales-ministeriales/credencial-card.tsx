        ...
        <div className="flex gap-2 ml-auto">
          ...
          <div className="relative w-full flex justify-center" style={{ perspective: '1000px' }}>
            ...
            <div className="text-center" style={{ marginBottom: '8px' }}>
              <h1 className="font-bold tracking-wide" style={{ fontSize: '17px', lineHeight: '1.1', margin: 0, color: '#0D374E', fontWeight: 700, textShadow: '0 1px 2px rgba(255,255,255,0.9)', letterSpacing: '0.3px' }}>
            ...
            {/* Sección principal con borde amarillo - Centrada y más grande */}
            <div className="flex justify-center items-center" style={{ marginBottom: '8px' }}>
              <div 
                className="relative"
                style={{
              ...
              >
                <div className="flex relative w-full" style={{ gap: '11px', alignItems: 'center', justifyContent: 'center' }}>
                  {/* Foto */}
                  <div className="flex-shrink-0" style={{ width: '127px' }}>
                    <div className="bg-white rounded border-2 border-gray-400 mb-0.5 flex items-center justify-center overflow-hidden shadow-md" style={{ width: '127px', height: '153px', borderRadius: '4px' }}>
                      {credencial.fotoUrl ? (
                        <Image
                        ...
                        <span className="text-gray-400 text-center px-1" style={{ fontSize: '9px' }}>FOTO</span>
                      )}
                    </div>
                    <div className="text-center font-semibold whitespace-nowrap" style={{ fontSize: '9px', color: '#0D374E', fontWeight: 600, textShadow: '0 1px 2px rgba(255,255,255,0.9)', lineHeight: '1.1' }}>
                      {credencial.tipoPastor} / SHEPHERD
                    </div>
                  </div>

                  {/* Información */}
                  <div className="flex-1 space-y-0.5 min-w-0" style={{ paddingTop: '0px', maxWidth: '373px' }}>
                    <div>
                      <div className="mb-0.5 font-medium" style={{ fontSize: '9px', color: '#0D374E', fontWeight: 500, textShadow: '0 1px 2px rgba(255,255,255,0.9)' }}>
                        Apellido / Surname
                      </div>
                      <div className="font-bold uppercase break-words" style={{ fontSize: '13px', lineHeight: '1.15', color: '#000000', fontWeight: 700 }}>
                        {credencial.apellido}
                      </div>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <div className="font-bold text-black font-mono break-words" style={{ fontSize: '13px', lineHeight: '1.15', color: '#000000', fontWeight: 700 }}>
                    ...
                    <div>
                      ...
                      <div className="font-bold break-words" style={{ fontSize: '13px', lineHeight: '1.15', color: '#000000', fontWeight: 700 }}>
                  ...
                  <div className="flex-shrink-0 flex items-center justify-center" style={{ width: '153px', height: '153px' }}>
                    <Image
                      src="/mundo.png"
                      alt="AMVA Logo"
                      width={153}
            ...
            <div className="text-center" style={{ marginTop: '5px' }}>
              <div className="font-bold mb-0.5" style={{ fontSize: '16px', lineHeight: '1.1', marginBottom: '2px', color: '#0D374E', fontWeight: 700, textShadow: '0 1px 2px rgba(255,255,255,0.9)' }}>
                CREDENCIAL MINISTERIAL INTERNACIONAL
              </div>
              <div style={{ fontSize: '9px', color: '#0D374E', fontWeight: 500, textShadow: '0 1px 2px rgba(255,255,255,0.9)' }}>
          ...
          >
            <div className="h-full flex flex-col" style={{ height: '100%' }}>
              {/* Header con Logo y Texto al lado */}
              <div className="flex items-start" style={{ gap: '11px', marginBottom: '5px' }}>
                ...
                <div className="flex-1" style={{ minWidth: 0 }}>
                  <div className="font-bold tracking-wide uppercase text-left" style={{ fontSize: '16px', lineHeight: '1.15', marginBottom: '3px', color: '#0D374E', fontWeight: 700, textShadow: '0 1px 2px rgba(255,255,255,0.9)' }}>
                    EL CONSEJO EJECUTIVO NACIONAL
                  </div>
                  <div className="leading-relaxed text-left" style={{ fontSize: '11px', lineHeight: '1.25', marginBottom: '0px', color: '#0D374E', fontWeight: 500, textShadow: '0 1px 2px rgba(255,255,255,0.9)' }}>
              ...
              <div style={{ marginBottom: '6px', marginTop: '3px' }}>
                <div className="font-bold text-center break-words" style={{ fontSize: '11px', color: '#0D374E', fontWeight: 700, textShadow: '0 1px 2px rgba(255,255,255,0.9)', lineHeight: '1.15' }}>
                  FICHERO de CULTO N 2753 PERSO.-JURIDICA 000-318 C.U.I.T.30-68748687-7
                </div>
              </div>

              {/* Footer: Firma (izquierda) y QR + Fecha (derecha) - Subido para mejor distribución */}
              <div className="flex justify-between items-end" style={{ marginTop: 'auto', gap: '11px', paddingTop: '0px' }}>
                {/* Firma - Izquierda */}
                <div className="flex-shrink-0" style={{ width: '160px' }}>
                  <div className="flex flex-col items-center justify-center" style={{ padding: '4px' }}>
                    <div className="w-full flex items-center justify-center overflow-hidden" style={{ height: '47px', marginBottom: '3px' }}>
                      <Image
                    ...
                    <div className="font-semibold text-center break-words" style={{ fontSize: '11px', color: '#0D374E', fontWeight: 600, textShadow: '0 1px 2px rgba(255,255,255,0.9)', lineHeight: '1.1' }}>FIRMA PRESIDENTE DEL C.E.N.</div>
                  </div>
                </div>

                {/* QR + Fecha - Derecha */}
                <div className="flex-shrink-0 flex flex-col items-end" style={{ gap: '5px' }}>
                  <div className="bg-white border-2 border-white/30 flex items-center justify-center" style={{ width: '73px', height: '73px', borderRadius: '3px' }}>
                    <span className="text-white/30 text-center" style={{ fontSize: '11px' }}>QR CODE</span>
                  </div>
                  <div className="font-bold text-right break-words" style={{ fontSize: '11px', color: '#0D374E', fontWeight: 700, textShadow: '0 1px 2px rgba(255,255,255,0.9)', lineHeight: '1.1' }}>VENCE: {fechaVencimiento}</div>
                </div>
              </div>
            </div>
          </div>
