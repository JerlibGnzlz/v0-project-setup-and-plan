...
export function InscripcionPagoWizard({
    ...
    const handlePagoUpdate = async (data: {
        ...
        try {
            if (selectedPago?.id) {
                ...
                toast.success(data.validarAutomaticamente ? '✅ Pago actualizado y validado' : 'Pago actualizado exitosamente')
                ...
                toast.success(data.validarAutomaticamente ? '✅ Pago creado y validado' : 'Pago creado exitosamente')
            }
    ...
    const getCuotasInfo = () => {
        ...
        const totalPagado = pagos
            ...
            .reduce((sum: number, p: any) => sum + (typeof p.monto === 'number' ? p.monto : parseFloat(String(p.monto || 0))), 0)
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Select
                                        value={formData.pais}
                                        onValueChange={(value) => {
                                            setFormData({ ...formData, pais: value, provincia: value !== 'Argentina' ? '' : formData.provincia })
                                        }}
                                    >
                                        <SelectTrigger>
                            ...
                            <div className="space-y-4">
                                <div className="p-3 bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 rounded-lg">
                                    ...
                                    <p className="text-sm text-blue-900 dark:text-blue-100">
                                        Revisa los datos de la inscripción y los pagos creados. Puedes gestionar los pagos desde la página de pagos.
                                    </p>
                                </div>
                                ...
                                <div className="p-4 bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-950/20 dark:to-teal-950/20 border border-emerald-200 dark:border-emerald-800 rounded-lg">
                                    <div className="flex items-center justify-between mb-3">
                                        ...
                                        <Badge variant={cuotasInfo.cuotasPagadas >= cuotasInfo.numeroCuotas ? 'default' : 'outline'}>
                                    ...
                                    <div className="grid grid-cols-3 gap-4 text-sm">
                                        <div>
                                            ...
                                            <p className="font-semibold">${costoTotal.toLocaleString('es-AR', { minimumFractionDigits: 2 })}</p>
                                        </div>
                                        <div>
                                            <span className="text-muted-foreground">Pagado:</span>
                                            <p className="font-semibold text-emerald-600 dark:text-emerald-400">
                                                ${cuotasInfo.totalPagado.toLocaleString('es-AR', { minimumFractionDigits: 2 })}
                                            </p>
                                        </div>
                                        <div>
                                            <span className="text-muted-foreground">Pendiente:</span>
                                            <p className="font-semibold text-amber-600 dark:text-amber-400">
                                                ${(costoTotal - cuotasInfo.totalPagado).toLocaleString('es-AR', { minimumFractionDigits: 2 })}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    {cuotasInfo.cuotas.map((cuota) => (
                                        ...
                                        >
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                {cuota.pago && cuota.pago.metodoPago && cuota.pago.metodoPago !== 'pendiente' && (
