...
export function CredencialCapellaniaFlipCardCompact({
  credencial,
  className,
}: CredencialCapellaniaFlipCardCompactProps) {
    ...
    <div className={cn('relative w-full', className)}>
      ...
      >
        ...
        >
          {/* FRENTE */}
          <div
            className="rounded-lg text-white shadow-xl border-2 border-green-300/30 overflow-hidden"
            style={{
              ...
              padding: '14px',
              background:
                'linear-gradient(135deg, #86efac 0%, #4ade80 10%, #22c55e 25%, #16a34a 40%, #15803d 60%, #166534 75%, #15803d 90%, #16a34a 100%)',
            }}
          >
            {/* Header */}
