...
export function CredencialCapellaniaCard({ credencial, onEdit, onBackToList }: CredencialCapellaniaCardProps) {
  ...
  const handlePrint = () => {
    ...
    printWindow.document.write(`
      ...
      <html>
      <head>
        <title>Credencial de Capellanía - ${credencial.nombre} ${credencial.apellido}</title>
        <style>
          * {
            margin: 0;
            padding: 0;
        ...
        <div class="credencial" style="width: 400px; height: 252px; min-width: 400px; min-height: 252px; max-width: 400px; max-height: 252px;">
          ...
          <div class="content">
            ...
            <div class="logo-section">
              <img src="/capellania.png" alt="Capellanía Logo" />
            </div>
          </div>
          <div class="footer">
            <div class="footer-title">CHAPLAIN MINISTERS INTERNATIONAL</div>
          ...
          <div class="dorso-content">
            ...
            <div style="margin-bottom: 6px;">
              <div style="text-align: center; font-size: 7px; font-weight: bold; color: #0D374E; word-break: break-word; text-shadow: 0 1px 2px rgba(255,255,255,0.9); line-height: 1.2;">
                FICHERO de CULTO N 2753 PERSO.-JURIDICA 000-113 C.U.I.T.30-68748687-7
              </div>
            </div>      
  ...
  return (
    <div className="relative w-full max-w-7xl mx-auto">
      ...
      {/* Card Container con Flip - Tamaño responsive para mejor visualización */}
      <div className="relative w-full flex justify-center" style={{ perspective: '1000px' }}>
        ...
        >
          {/* FRENTE - Tamaño responsive para mejor visualización */}
          <div
            className="rounded-lg text-white shadow-xl border-2 border-green-300/30 overflow-hidden absolute inset-0 flex flex-col"
            style={{
          ...
          >
            {/* Header */}
            <div className="text-center flex-shrink-0" style={{ marginBottom: 'clamp(4px, 0.8vw, 8px)' }}>
              <h1 className="font-bold tracking-wide" style={{ fontSize: 'clamp(11px, 1.6vw, 20px)', lineHeight: '1.1', margin: 0, color: '#0D374E', fontWeight: 700, textShadow: '0 1px 2px rgba(255,255,255,0.9)', letterSpacing: '0.3px' }}>
            ...
            <div className="flex justify-center items-center flex-1 overflow-hidden" style={{ marginBottom: 'auto', minHeight: 0 }}>
              <div className="flex relative w-full h-full" style={{ gap: 'clamp(6px, 1vw, 12px)', alignItems: 'center', justifyContent: 'center' }}>
                {/* Foto */}
                <div className="flex-shrink-0 flex flex-col" style={{ width: 'clamp(70px, 12vw, 140px)' }}>
                  <div className="bg-white rounded border-2 border-gray-400 mb-0.5 flex items-center justify-center overflow-hidden shadow-md" style={{ width: '100%', aspectRatio: '88 / 108', borderRadius: '4px', maxHeight: '85%' }}>
                    {credencial.fotoUrl ? (
                      <Image
                      ...
                      <span className="text-gray-400 text-center px-1" style={{ fontSize: 'clamp(6px, 0.8vw, 10px)' }}>FOTO</span>
                    )}
                  </div>
                ...
                {/* Información - Asegurar que todo quepa */}
                <div className="flex-1 min-w-0 flex flex-col justify-center overflow-hidden" style={{ paddingTop: '0px', paddingBottom: '0px', maxWidth: 'clamp(180px, 35vw, 450px)', height: '100%' }}>
                  <div className="space-y-0.5 flex-1 flex flex-col justify-center" style={{ gap: 'clamp(2px, 0.3vw, 4px)' }}>
                    <div className="min-h-0 flex-shrink-0">
                      <div className="mb-0.5 font-medium leading-tight" style={{ fontSize: 'clamp(6px, 0.8vw, 11px)', color: '#0D374E', fontWeight: 500, textShadow: '0 1px 2px rgba(255,255,255,0.9)', lineHeight: '1.1' }}>
                        Apellido / Surname
                      </div>
                      <div className="font-bold uppercase break-words leading-tight overflow-wrap-anywhere" style={{ fontSize: 'clamp(9px, 1.2vw, 16px)', lineHeight: '1.15', color: '#000000', fontWeight: 700, wordBreak: 'break-word' }}>
                        {credencial.apellido}
                      </div>
                    </div>
                    <div className="min-h-0 flex-shrink-0">
                    ...
                    <div className="min-h-0 flex-shrink-0">
                      ...
                      <div className="font-bold text-black font-mono break-words leading-tight overflow-wrap-anywhere" style={{ fontSize: 'clamp(9px, 1.2vw, 16px)', lineHeight: '1.15', color: '#000000', fontWeight: 700, wordBreak: 'break-word' }}>
                    ...
                    <div className="min-h-0 flex-shrink-0">
                      ...
                      <div className="font-bold break-words leading-tight overflow-wrap-anywhere" style={{ fontSize: 'clamp(9px, 1.2vw, 16px)', lineHeight: '1.15', color: '#000000', fontWeight: 700, wordBreak: 'break-word' }}>
                ...
                {/* Logo Capellanía - Reducido para dar más espacio */}
                <div className="flex-shrink-0 flex items-center justify-center" style={{ width: 'clamp(80px, 14vw, 160px)', height: 'clamp(80px, 14vw, 160px)' }}>
                  <Image
                    src="/capellania.png"
                    alt="Capellanía Logo"
                    width={160}
            ...
            <div className="text-center flex-shrink-0" style={{ marginTop: 'auto', paddingTop: 'clamp(4px, 0.8vw, 8px)' }}>
              <div className="font-bold mb-0.5" style={{ fontSize: 'clamp(10px, 1.4vw, 18px)', lineHeight: '1.1', marginBottom: '2px', color: '#0D374E', fontWeight: 700, textShadow: '0 1px 2px rgba(255,255,255,0.9)' }}>
                CHAPLAIN MINISTERS INTERNATIONAL
              </div>
              <div style={{ fontSize: 'clamp(6px, 0.8vw, 11px)', color: '#0D374E', fontWeight: 500, textShadow: '0 1px 2px rgba(255,255,255,0.9)', lineHeight: '1.1' }}>
                SEDE SOCIAL: PICO 1641 (1429) CAPITAL FEDERAL
              </div>
            </div>
          </div>

          {/* DORSO - Tamaño responsive para mejor visualización */}
          <div
          ...
          >
            <div className="h-full flex flex-col" style={{ height: '100%' }}>
              {/* Header con Logo y Texto al lado */}
              <div className="flex items-start" style={{ gap: 'clamp(10px, 1.5vw, 16px)', marginBottom: 'clamp(6px, 1vw, 8px)' }}>
                <div className="flex-shrink-0">
                  <Image
                    ...
                    style={{ width: 'clamp(70px, 12vw, 140px)', height: 'clamp(70px, 12vw, 140px)' }}
                  />
                </div>
                <div className="flex-1" style={{ minWidth: 0 }}>
                  <div className="font-bold tracking-wide uppercase text-left" style={{ fontSize: 'clamp(11px, 1.8vw, 22px)', lineHeight: '1.15', marginBottom: '4px', color: '#0D374E', fontWeight: 700, textShadow: '0 1px 2px rgba(255,255,255,0.9)' }}>
                    EL CONSEJO EJECUTIVO NACIONAL
                  </div>
                  <div className="leading-relaxed text-left" style={{ fontSize: 'clamp(8px, 1.2vw, 15px)', lineHeight: '1.3', marginBottom: '0px', color: '#0D374E', fontWeight: 500, textShadow: '0 1px 2px rgba(255,255,255,0.9)' }}>
              ...
              <div style={{ marginBottom: 'clamp(6px, 1vw, 8px)', marginTop: '4px' }}>
                <div className="font-bold text-center break-words" style={{ fontSize: 'clamp(7px, 1.2vw, 15px)', color: '#0D374E', fontWeight: 700, textShadow: '0 1px 2px rgba(255,255,255,0.9)', lineHeight: '1.2' }}>
                  FICHERO de CULTO N 2753 PERSO.-JURIDICA 000-113 C.U.I.T.30-68748687-7
                </div>
              </div>

              {/* Footer: Firma (izquierda) y QR + Fecha (derecha) - Subido para mejor distribución */}
              <div className="flex justify-between items-end" style={{ marginTop: 'auto', gap: 'clamp(10px, 1.5vw, 16px)', paddingTop: '0px' }}>
                {/* Firma - Izquierda */}
                <div className="flex-shrink-0" style={{ width: 'clamp(155px, 20vw, 220px)' }}>
                  <div className="flex flex-col items-center justify-center" style={{ padding: 'clamp(4px, 0.5vw, 6px)' }}>
                    <div className="w-full flex items-center justify-center overflow-hidden" style={{ height: 'clamp(45px, 6vw, 66px)', marginBottom: '4px' }}>
                      <Image
                        ...
                        onError={(e) => {
                          ...
                          if (parent && !parent.querySelector('span')) {
                            ...
                            placeholder.style.fontSize = 'clamp(7px, 1vw, 15px)'
                    ...
                    <div className="font-semibold text-center break-words" style={{ fontSize: 'clamp(7px, 1vw, 15px)', color: '#0D374E', fontWeight: 600, textShadow: '0 1px 2px rgba(255,255,255,0.9)', lineHeight: '1.1' }}>FIRMA PRESIDENTE DEL C.E.N.</div>
                  </div>
                </div>

                {/* QR + Fecha - Derecha */}
                <div className="flex-shrink-0 flex flex-col items-end" style={{ gap: 'clamp(4px, 0.5vw, 7px)' }}>
                  <div className="bg-white border-2 border-white/30 flex items-center justify-center overflow-hidden" style={{ width: 'clamp(72px, 10vw, 103px)', height: 'clamp(72px, 10vw, 103px)', borderRadius: '4px', padding: '4px' }}>
                    <Image
                      src="/qr.png"
                      alt="QR Code"
                      width={95}
                  ...
                  <div className="font-bold text-right break-words" style={{ fontSize: 'clamp(7px, 1vw, 15px)', color: '#0D374E', fontWeight: 700, textShadow: '0 1px 2px rgba(255,255,255,0.9)', lineHeight: '1.1' }}>VENCE: {fechaVencimiento}</div>
                </div>
              </div>
            </div>
          </div>
