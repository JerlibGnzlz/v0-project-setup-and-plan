...
export function InscripcionExistenteCard({
  ...
  const totalPagado = pagos
    ...
    .reduce(
      (sum, p) => sum + (typeof p.monto === 'number' ? p.monto : parseFloat(String(p.monto || 0))),
      0
    )
                        ...
                        <img
                          ...
                          onError={e => {
                            if (process.env.NODE_ENV === 'development') {
                              console.warn(
                                '[InscripcionExistenteCard] Error cargando foto, mostrando iniciales:',
                                user.fotoUrl
                              )
                            }
                            setImageError(true)
                      ...
                      <div className="flex items-center gap-3">
                        <div
                          className={cn(
                            ...
                            estaPagada ? 'bg-emerald-500 text-white' : 'bg-white/10 text-white/50'
                          )}
                        >
            ...
            <div className="p-5 bg-white/5 border border-white/10 rounded-xl shadow-lg">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="pt-3 border-t border-white/10">
                  <p className="text-xs text-white/40">Inscrito el {fechaInscripcion}</p>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <div className="flex-1">
                    ...
                    <ul className="text-xs text-white/70 space-y-1.5 list-disc list-inside">
                      ...
                      {inscripcion.codigoReferencia && (
                        <li>
                          Incluye el código{' '}
                          <strong className="text-amber-400">{inscripcion.codigoReferencia}</strong>{' '}
                          en la transferencia
                        </li>
                      )}
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-white/70">
                      Todos tus pagos han sido validados. Tu inscripción está confirmada. Te
                      esperamos en la convención.
                    </p>
                  </div>
                </div>
              </div>
